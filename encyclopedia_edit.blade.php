...
<div class="edit_main">
	...
	<div class="edit_right">
		<div class="e_r_nr" style="margin-left:15%">
			...
			<a href="javascript:;" class="an an_preview" onClick="window.location.href='/encyclopedia/introduction_YuLan/{{@$data['id']}}';">预览</a>
		</div>
	</div>
		</form>
</div>
...
<div class="tan" id="gaishu" style="display: none;" >
	<div class="tan_main">
		...
		<div class="tan_nr">
			<label class="imgD">
				<img src="/index/member/images/default.png" class="img1 preview" alt="">
...
<script>
	$(function(){
       ...
       //概述图片介绍
        ...
        //批量上传图片 ---弹出层 删除
//        $('body').on('click','#piclistdel .del',function(){
...
//        })
		...
		$(".duotu").click(function(){
			...
			for(var i = 0; i < liNo; i++){
				...
				addpiclist += '<img src="'+imgSrc+'" class="img1" alt="">';
